...
import com.easyranktools.easyranktools.custom.LayoutChooseContact;
import com.easyranktools.easyranktools.custom.ViewTabMode;
import com.easyranktools.easyranktools.dialog.FavResult;
import com.easyranktools.easyranktools.fragment.ContactResult;
import com.easyranktools.easyranktools.fragment.FragmentContact;
import com.easyranktools.easyranktools.fragment.FragmentFavorites;
import com.easyranktools.easyranktools.fragment.FragmentInfo;
import com.easyranktools.easyranktools.fragment.FragmentPad;
import com.easyranktools.easyranktools.fragment.FragmentRecents;
import com.easyranktools.easyranktools.fragment.FragmentSetting;
...
import com.easyranktools.easyranktools.ads.InterstitialAdManager;
...
public class ActivityHome extends AppCompatActivity {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.activity_home_with_ads);
        getDataCall();
        initContact();
        initView();
        
        // Initialize our comprehensive ad system
        initAds();

        // Keep existing AdAdmob for compatibility
    ...
    private void initAds() {
        ...
        interstitialAdManager.setListener(new InterstitialAdManager.InterstitialAdListener() {
            @Override
            public void onAdClosed() {
                // Ad closed, continue with normal flow
            }
            
            @Override
            public void onAdFailedToLoad() {
                // Ad failed to load, continue with normal flow
            }
        });
    ...
    public void showInterstitialAd() {
        if (adManager.shouldShowAds() && interstitialAdManager != null) {
            interstitialAdManager.showInterstitialAd();
        }
    }
